...
// type viewModifier func(screen *ebiten.Image, current *uiViewBack)

// func backgroundColorViewModifier(clr color.Color) viewModifier {
// 	return func(screen *ebiten.Image, current *uiViewBack) {
...
// 	return func(_ *ebiten.Image, current *uiViewBack) {
// 		if current == nil {
// 			return
// 		}
...
// 		current.initSize = size{rpEq(w, -1, current.initSize.w), rpEq(h, -1, current.initSize.h)}
// 		current.size = size{rpEq(w, -1, current.size.w), rpEq(h, -1, current.size.h)}
// 	}
// }
